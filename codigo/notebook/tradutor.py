...
get_ipython().system('cp "/content/drive/My Drive/Projetos/IA/raw_data/gu-pt.txt" "gu-pt.txt"')
get_ipython().system('cp "/content/drive/My Drive/Projetos/IA/raw_data/xa-pt.txt" "xa-pt.txt"')
get_ipython().system('cp "/content/drive/My Drive/Projetos/IA/raw_data/ka-pt.txt" "ka-pt.txt"')
get_ipython().system('cp "/content/drive/My Drive/Projetos/IA/raw_data/tu-pt.txt" "tu-pt.txt"')
